# Begin systemd-ch5-build.sh

echo "You have to have everything downloaded"
echo "sudo mkdir $LSF (/mnt/lfs)"
echo "sudo mkdir $LSF/sources"
echo "sudo chmod -v a+wt $LFS/sources"
echo "create wget-list chapter 3.1"
echo "wget --input-file=wget-list --continue --directory-prefix=$LFS/sources"

cd $LFS/sources

echo "007aabf1dbb550bcddde52a244cd1070  acl-2.2.53.tar.gz
...
4900322141d493e74020c9cf437b2cdc  sysvinit-2.96-consolidated-1.patch" > md5sums
